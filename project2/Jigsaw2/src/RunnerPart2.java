...
public class RunnerPart2 {
	...
	// 执行启发式搜索示例算法
		...
		path += jigsaw.getCurrentJNode().getNodeDepth();
	    }
	    
	    
	}

	System.out.println("total complete  " + countComplete);
	System.out.println("average step  " +( average / countComplete));
	System.out.println("average step  " +( path / countComplete));
    }
